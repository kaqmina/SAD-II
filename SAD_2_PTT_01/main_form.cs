...
namespace SAD_2_PTT_01
{
    public partial class main_form : Form
    {
        ...
        public void load_reports()
        {
            ...
            conn_rep.project_grid(project_grid);
        ...
        {
            reports_pnl_visible();
            reports_pnl_pwd.Visible = date_format.Enabled = true;
            hide_date();
        ...
        {
            reports_pnl_visible();
            reports_pnl_device.Visible = date_format.Enabled = true;
            hide_date();
        ...
        {
            reports_pnl_visible();
            reports_pnl_projects.Visible = date_format.Enabled = true;
            hide_date();
        ...
        private void btn_ok_Click(object sender, EventArgs e)
        {
            ...
            if (reports_pnl_pwd.Visible == true && reports_pnl_projects.Visible == false && reports_pnl_device.Visible == false)
                ...
                conn_rep.date_project_format(project_grid, date, from, to);
        }
        #endregion
        ...
        private void reports_btn_project_summary_Click(object sender, EventArgs e)
        {
            ...
            {
                conn_rep.project_reportPDF(file, date, project_grid);
                System.Diagnostics.Process.Start(file); 
            }
            save_pdf.FileName = "";
        }
