...
CREATE TABLE `pwd` (
  ...
  `registration_no` int(50) DEFAULT NULL,
  ...
  `added_date` varchar(50) DEFAULT NULL COMMENT 'Date added by the employee',
...
INSERT INTO `pwd` VALUES (1,1,NULL,'Mina','K Ann','Quinones',1,4,'Davao City','A','1998-10-04',NULL,2823159,0,'secret@gmail.com',1,'Filipino',NULL,NULL,'2017-06-20','Hernaez, Marianne Presto',1,1,1,NULL,2,1,0),(2,2,NULL,'Bangay','Abigail Blanche','Aquino',1,6,'Davao City','B','1999-07-13',NULL,0,0,'food@gmail.com',2,'Filipino',NULL,NULL,'2017-06-20','Fernandez, Jamie Jaria Pie',2,3,1,NULL,4,0,0);
...
CREATE TABLE `pwd_otherinfo` (
  ...
  `phealth_status` int(11) DEFAULT NULL COMMENT '1 - Member\n2 - Dependent',
...
INSERT INTO `pwd_otherinfo` VALUES (1,243,243,432,1,'dgfd1','gfdg','fdgdg',23231,'fhfhgf'),(2,765,35,98,2,'afda','gjkh','jkhgj',12113,'jgjhg');
...
-- Dump completed on 2017-08-01  9:26:22
