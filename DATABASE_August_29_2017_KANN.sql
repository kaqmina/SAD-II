...
INSERT INTO `employee` VALUES (1,'K Ann','Quinones','Mina','Davao CIty','Admin',NULL,NULL,1,'admin','admin'),(2,'Coleen Pia','Galero','Larena','Davao City','Admin',NULL,NULL,1,'root','root'),(3,'Abigail Blanche','Aquino','Bangay','Davao City','Admin',NULL,NULL,0,'exile','exile');
...
CREATE TABLE `parental_info` (
  ...
  CONSTRAINT `parental_info_pwd_id` FOREIGN KEY (`pwd_id`) REFERENCES `pwd` (`pwd_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `parental_info` VALUES (1,'Ricardo','Bayani','Mina','Marichu','Quinones','Mina','Jamie','Hernaez','Marianne'),(2,'Abigail','Aquino','Bangay','Abby','Aquino','Bangay','Food','Drinks','Sleep'),(32,'sdf','fdsf','addf','yuruy','truyt','hyytry','uytr','uytr','uytr');
...
CREATE TABLE `project` (
  ...
  `project_title` varchar(60) DEFAULT NULL COMMENT 'Required',
  `project_desc` varchar(100) DEFAULT NULL,
  `start_time` datetime DEFAULT NULL COMMENT 'Required',
  `end_time` datetime DEFAULT NULL COMMENT 'Required',
  ...
  `budget` int(11) DEFAULT NULL COMMENT 'Required\n-----------\ntotal cost can be determined through ''items'' table',
  `budget_desc` varchar(100) DEFAULT NULL,
  `isArchived` tinyint(4) DEFAULT NULL COMMENT '0 - Not Archived\n1 - Archived',
...
INSERT INTO `project` VALUES (1,1,NULL,NULL,'Systems Analysis Design - Software Engineering','Need to make sure it is deployable.','2017-08-25 09:00:00','2017-08-30 05:00:00','2017-08-21','Officer-in-Charge','Rizal Park',9000,'Given by the superiors',0);
...
INSERT INTO `project_items` VALUES (1,1,'Ticket','Official ones',90,3),(2,1,'Card','BancNet',0,1),(3,1,'Bag','Brown',1000,3);
...
CREATE TABLE `project_persons` (
  ...
  `project_id` int(11) NOT NULL,
  `pwd_id` int(11) NOT NULL,
  `attendance` tinyint(4) DEFAULT '0' COMMENT 'Required\n-----------\nIf the PWD attended the event or not.\n0 - Absent\n1 - Present',
...
INSERT INTO `project_persons` VALUES (3,1,1,0),(4,1,2,1),(5,1,32,1);
...
CREATE TABLE `project_progress` (
  ...
  `progress_type` varchar(45) DEFAULT NULL COMMENT 'Proposed\nOngoing\nCancelled\nFinished',
  `date_changed` datetime DEFAULT NULL,
  PRIMARY KEY (`progress_id`),
  KEY `progress_project_id_idx` (`project_id`),
  CONSTRAINT `progress_project_id` FOREIGN KEY (`project_id`) REFERENCES `project` (`project_id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `project_progress` VALUES (1,1,'1','2017-08-21 05:00:00');
...
CREATE TABLE `pwd` (
  ...
  `added_date` date DEFAULT NULL COMMENT 'Date added by the employee',
  `application_date` date NOT NULL COMMENT 'Required',
  `educ_attainment` int(11) DEFAULT NULL,
  `employment_status` int(11) DEFAULT NULL COMMENT '1 - Employed\n2 - Resigned\n3 - Unemployed\n4 - Displaced Worker\n5 - Retired\n6 - Returning Overseas Filipino Worker',
  `nature_of_employer` int(11) DEFAULT NULL COMMENT '1 - Private\n2 - Government',
  `type_of_employment` int(11) DEFAULT NULL COMMENT '1 - Contractual\n2 - Permanent\n3 - Self-Employed\n4 - Seasonal',
  `type_of_skill` int(11) DEFAULT NULL,
  `status_pwd` int(11) DEFAULT '1' COMMENT 'Required\n-----------\n[Membership status]\n0 - Inactive/Expired\n1 - Active',
  `isArchived` tinyint(4) DEFAULT '0' COMMENT '0 - Not Archived\n1 - Archived',
  `address_house_no_street` varchar(50) DEFAULT NULL,
  ...
  KEY `pwd_district_id_idx` (`district_id`),
  CONSTRAINT `pwd_district_id` FOREIGN KEY (`district_id`) REFERENCES `pwd_district` (`district_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `pwd` VALUES (1,1,2,'2222','Mina','K Ann','Quinones',1,4,'1','2017-06-20',NULL,'2823159','0','secret@gmail.com',1,'Filipino','2020-06-20',NULL,'2017-06-20',1,1,1,2,2,1,0,'Blk. 12 Lot 8 Cecilia Heights Phase 2','Cabantian','Buhangin','Davao del Sur'),(2,2,1,'2343','Bangay','Abigail Blanche','Aquino',0,6,'3','1999-08-14',NULL,'0','9789','food@gmail.com',2,'Filipino','2020-06-20','2017-08-22','2017-06-20',2,1,1,1,4,0,0,'House No. and Street','Barangay','Municipality','Province'),(3,1,1,'234234','sdfgsg','dfsg','sdfg',1,4,'2','2017-08-19',NULL,'3234','1232','fdsgsdfg',2,'agdf','2020-08-18','2017-08-19','2017-08-18',0,1,2,1,1,0,0,'sghfg','sfhd','asdfae','adfasf'),(32,1,1,'222123231','sfew','trweerw','twrwr',0,4,'3','2017-08-22',NULL,'2132312','12312312312','324234dsgfgd',1,'wew','2020-08-18','2017-08-22','2017-08-18',1,1,2,2,9,1,0,'wtrw','tewtr','wrw','twr');
/*!40000 ALTER TABLE `pwd` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `pwd_district`
--

DROP TABLE IF EXISTS `pwd_district`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pwd_district` (
...
--
-- Dumping data for table `pwd_district`
--

LOCK TABLES `pwd_district` WRITE;
/*!40000 ALTER TABLE `pwd_district` DISABLE KEYS */;
INSERT INTO `pwd_district` VALUES (1,'Toril'),(2,'Davao'),(3,'Agdao');
/*!40000 ALTER TABLE `pwd_district` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `pwd_emp_log` VALUES (1,1,1,'2017-08-20'),(2,2,1,'2017-08-20'),(3,3,2,'2017-08-20');
...
CREATE TABLE `pwd_otherinfo` (
  ...
  `phealth_no` varchar(20) DEFAULT NULL,
  `phealth_status` tinyint(4) DEFAULT NULL COMMENT '1 - Member\n2 - Dependent',
  `organization_aff` varchar(45) DEFAULT NULL,
  `contact_person` varchar(45) DEFAULT NULL,
  `office_address` varchar(45) DEFAULT NULL,
  `tel_no` varchar(20) DEFAULT NULL,
  `name_of_reporting_unit` varchar(60) DEFAULT NULL,
  `accomplished_by_fn` varchar(45) DEFAULT NULL,
  `accomplished_by_mn` varchar(45) DEFAULT NULL,
  `accomplished_by_ln` varchar(45) DEFAULT NULL,
  KEY `pwd_otherinfo_pwd_id_idx` (`pwd_id`),
  CONSTRAINT `pwd_otherinfo_pwd_id` FOREIGN KEY (`pwd_id`) REFERENCES `pwd` (`pwd_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `pwd_otherinfo` VALUES (1,'243','243','432',1,'dgfd1','gfdg','fdgdg','23231','fhfhgf','Jamie ','Jaira','Fernandez'),(2,'765','35','98',2,'afda','gjkh','jkhgj','0000','jgjhg','Abigail Blanche','Aquino','Bangay'),(32,'23424','234234','234',1,'dsfafsfa','12312313','sdfsdf','13123','uytru','uytr','uytr','uytr');
...
-- Dump completed on 2017-08-29  9:28:10
